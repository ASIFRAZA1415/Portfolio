      ...
      <motion.div
       ...
       className='flex w-full flex-col lg:flex-row items-center gap-20 my-20 '>
        ...
        className='flex-1'>
          ...
          <p className='mb-10 max-w-2xl font-Ovo'>I’m a Frontend Developer skilled in JavaScript and React.js, passionate about building responsive, user‑friendly web applications.
             I have developed projects like an e‑commerce platform and an admin dashboard, with a strong focus on performance, modern design,
              and clean code. Always eager to learn and adapt to the latest front‑end technologies to deliver engaging digital experiences.</p>
