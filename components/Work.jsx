     ...
     id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      transition={{duration: 0.5, delay: 0.7}}
       className='text-center max-w-2xl mx-auto  mt-5 mb-12 font-Ovo'>
        Welcome to my developmet portfolio! Explore a collection of projects
         showcasing my experties in front-end developmet.</motion.p>
         ...
         transition={{duration: 0.6, delay: 0.9}}
          className='grid grid-cols-auto sm:grid-cols-2 lg:grid-cols-4 my-10 gap-5 dark:text-black'>
